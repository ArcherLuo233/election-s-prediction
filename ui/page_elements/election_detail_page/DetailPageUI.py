...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.btn_predict = QtWidgets.QPushButton(Dialog)
        font = QtGui.QFont()
        font.setFamily("华文新魏")
        font.setPointSize(18)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.btn_addyear.setText(_translate("Dialog", "修改年度数据"))
        self.btn_addpeople.setText(_translate("Dialog", "修改候选者数据"))
        self.btn_predict.setText(_translate("Dialog", "得票率预测"))
        ...
        item.setText(_translate("Dialog", "当选者"))
