...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_add_condition.setFont(font)
        ...
        self.btn_downloadTemplate.setFont(font)
        ...
        self.horizontalLayout_6.addWidget(self.btn_select_all)
        self.btn_select_null = QtWidgets.QPushButton(self.frame_2)
        font = QtGui.QFont()
        font.setFamily("华文新魏")
        font.setPointSize(17)
        self.btn_select_null.setFont(font)
        ...
        self.horizontalLayout_6.addWidget(self.btn_select_null)
        self.lable_11 = QtWidgets.QLabel(self.frame_2)
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(16)
        self.lable_11.setFont(font)
        self.lable_11.setObjectName("lable_11")
        self.horizontalLayout_6.addWidget(self.lable_11)
        self.sum = QtWidgets.QLabel(self.frame_2)
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(16)
        self.sum.setFont(font)
        self.sum.setObjectName("sum")
        self.horizontalLayout_6.addWidget(self.sum)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_6.addItem(spacerItem3)
        self.btn_mul_delete_all = QtWidgets.QPushButton(self.frame_2)
        font = QtGui.QFont()
        font.setFamily("华文新魏")
        font.setPointSize(17)
        self.btn_mul_delete_all.setFont(font)
        self.btn_mul_delete_all.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btn_mul_delete_all.setObjectName("btn_mul_delete_all")
        self.horizontalLayout_6.addWidget(self.btn_mul_delete_all)
        self.btn_mul_export = QtWidgets.QPushButton(self.frame_2)
        font = QtGui.QFont()
        font.setFamily("华文新魏")
        font.setPointSize(17)
        self.btn_mul_export.setFont(font)
        self.btn_mul_export.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btn_mul_export.setObjectName("btn_mul_export")
        self.horizontalLayout_6.addWidget(self.btn_mul_export)
        self.btn_mul_delete = QtWidgets.QPushButton(self.frame_2)
        font = QtGui.QFont()
        font.setFamily("华文新魏")
        font.setPointSize(17)
        self.btn_mul_delete.setFont(font)
        self.btn_mul_delete.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btn_mul_delete.setObjectName("btn_mul_delete")
        self.horizontalLayout_6.addWidget(self.btn_mul_delete)
    ...
    def retranslateUi(self, Form):
        ...
        self.lable_11.setText(_translate("Form", "人数总计:"))
        self.sum.setText(_translate("Form", "TextLabel"))
        self.btn_mul_delete_all.setText(_translate("Form", "全部删除"))
