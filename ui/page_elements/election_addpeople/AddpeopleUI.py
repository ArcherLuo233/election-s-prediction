...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.cpwl = QtWidgets.QLabel(Dialog)
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(16)
        self.cpwl.setFont(font)
        self.cpwl.setObjectName("cpwl")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.cpwl)
        self.cpwl_text = QtWidgets.QLineEdit(Dialog)
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(14)
        self.cpwl_text.setFont(font)
        self.cpwl_text.setObjectName("cpwl_text")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.cpwl_text)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cpwl.setText(_translate("Dialog", "与上期相比:"))
        self.cpwl_text.setPlaceholderText(_translate("Dialog", "请输入与上期相比值"))
