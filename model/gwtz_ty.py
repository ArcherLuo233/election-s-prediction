...
class GWTZ_TY(Base):
    ...
    type = Column(String(10000), comment='人物类型')
    nature = Column(String(10000), comment='人员性质')
    taiwan_position = Column(String(10000), comment='赴台身份及职务')
    entry_number = Column(String(10000), comment='入台证号')
    pass_number = Column(String(10000), comment='通行证号')
    filing_form = Column(String(10000), comment='备案表')
